...
public class henchmenHandler {
    ...
    public LivingEntity convertToHenchmen(final Zombie z) {
        ...
        z.getAttribute(Attribute.MAX_HEALTH)
                .setBaseValue((double) zCM.getHenchmenConfig().getDouble("Henchmen.MaxHealth"));
        ...
        z.getAttribute(Attribute.FOLLOW_RANGE)
                .setBaseValue((double) zCM.getHenchmenConfig().getDouble("Henchmen.FollowRange"));
        z.getAttribute(Attribute.ATTACK_DAMAGE)
                .setBaseValue((double) zCM.getHenchmenConfig().getDouble("Henchmen.AttackDamage"));
        z.getAttribute(Attribute.MOVEMENT_SPEED)
                .setBaseValue((double) zCM.getHenchmenConfig().getDouble("Henchmen.MovementSpeed"));
        ...
        ItemStack mainHand = new ItemStack(
                Material.getMaterial(zCM.getHenchmenConfig().getString("Henchmen.MainHand")));
        // ItemStack offHand = new
        // ItemStack(Material.getMaterial(zCM.getHenchmenConfig().getString("Henchmen.OffHand")));
