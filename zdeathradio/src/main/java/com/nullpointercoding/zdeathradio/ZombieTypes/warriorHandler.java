...
public class warriorHandler {
    ...
    public LivingEntity convertToWarrior(final Zombie z){
        ...
        z.getAttribute(Attribute.GENERIC_MAX_HEALTH).setBaseValue((double) zCM.getWarriorConfig().getDouble("Warrior.MaxHealth"));
		...
		z.getAttribute(Attribute.GENERIC_FOLLOW_RANGE).setBaseValue((double) zCM.getWarriorConfig().getDouble("Warrior.FollowRange"));
		z.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE).setBaseValue((double) zCM.getWarriorConfig().getDouble("Warrior.AttackDamage"));
		z.getAttribute(Attribute.GENERIC_MOVEMENT_SPEED).setBaseValue((double) zCM.getWarriorConfig().getDouble("Warrior.MovementSpeed"));
       ...
       // ItemStack offHand = new ItemStack(Material.getMaterial(zCM.getWarriorConfig().getString("Warrior.OffHand")));
