...
public class bruteHandler {
    ...
    public LivingEntity convertToBrute(final Zombie z) {
        ...
        z.getAttribute(Attribute.MAX_HEALTH).setBaseValue((double) zCM.getBruteConfig().getDouble("Brute.MaxHealth"));
        ...
        z.getAttribute(Attribute.FOLLOW_RANGE)
                .setBaseValue((double) zCM.getBruteConfig().getDouble("Brute.FollowRange"));
        z.getAttribute(Attribute.ATTACK_DAMAGE)
                .setBaseValue((double) zCM.getBruteConfig().getDouble("Brute.AttackDamage"));
        z.getAttribute(Attribute.MOVEMENT_SPEED)
                .setBaseValue((double) zCM.getBruteConfig().getDouble("Brute.MovementSpeed"));
        ...
        // ItemStack(Material.getMaterial(zCM.getBruteConfig().getString("Brute.OffHand")));
